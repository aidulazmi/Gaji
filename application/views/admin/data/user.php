              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $u->hp ?></td>
                    <td>
                      <a class="btn btn-info btn-sm" href="<?php echo site_url('C_admin/edit_user/'.$u->id_user);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_admin/hapus_user/'.$u->id_user);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
            ...
            <form action="<?php echo site_url('C_admin/simpan_user')?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Lengkap" name="nama_lengkap" required>
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control" name="id_jabatan" id="id_jabatan">
                          <option value="" selected>Silahkan Isi Jabatan</option>
                            <?php                                
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Bagian" name="bagian" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alamat</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Alamat" name="alamat" required>
                  </div>
                  <div class="form-group">
                        <label>Jenis Kelamin</label>
                        <select class="form-control" name="jk" id="jk">
                          <option value="l" selected>Silahkan Pilih Bulan</option>
                  ...
                  <div class="form-group">
                        ...
                        <select class="form-control" name="agama" id="jk">
                          <option value="i" selected>Silahkan Pilih Agama</option>
                          <option value="i">Islam</option>
                          <option value="p">Kristen Protestan</option>
                          <option value="k">Kristen Katholik</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan No HP" onkeypress="return event.charCode >= 48 && event.charCode <=57" name="hp" required>
                  </div>
                  <div class="form-group">
